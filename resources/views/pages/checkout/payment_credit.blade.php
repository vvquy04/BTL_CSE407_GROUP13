                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <p style="color: #28a745; font-weight: bold; font-size: 16px;">
                                    <i class="fa fa-credit-card"></i> {{ Session::get('order_info.payment_method') }}
                                </p>
                            </div>
                            <div class="col-md-6">
                                <p><strong>Phương thức vận chuyển:</strong></p>
                                <p style="color: #28a745; font-weight: bold; font-size: 16px;">
                                    {{ Session::get('order_info.shipping_method') }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="row" style="margin-top: 15px;">
                            <div class="col-md-6">
                                ...
                                <p style="color: #6c757d; font-weight: bold;">
                                    {{ Session::get('order_info.transaction_id') }}
                                </p>
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="next-steps" style="margin: 40px auto; max-width: 600px;">
                        ...
                        <div class="alert alert-info">
                            <ul style="text-align: left; margin: 0; padding-left: 20px;">
                                <li>Chúng tôi sẽ xác nhận đơn hàng qua email trong vòng 30 phút</li>
