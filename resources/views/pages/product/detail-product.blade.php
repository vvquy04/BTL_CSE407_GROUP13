...
<div class="product-details"><!--product-details-->
        ...
        <div id="similar-product" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        <a href=""><img src="{{URL::to('frontend/img/product-details/similar1.jpg')}}" alt=""></a>
                        <a href=""><img src="{{URL::to('frontend/img/product-details/similar2.jpg')}}" alt=""></a>
                        <a href=""><img src="{{URL::to('frontend/img/product-details/similar3.jpg')}}" alt=""></a>
                    </div>
                    <div class="item">
                        <a href=""><img src="{{URL::to('frontend/img/product-details/similar1.jpg')}}" alt=""></a>
                        <a href=""><img src="{{URL::to('frontend/img/product-details/similar2.jpg')}}" alt=""></a>
    ...
    <div class="col-sm-7">
        <div class="product-information"><!--/product-information-->
            ...
            <!-- <a href=""><img src="{{URL::to('frontend/img/product-details/share.png')}}" class="share img-responsive"  alt="" /></a> -->
        ...
        <div class="tab-pane fade" id="reviews" >
            <div class="col-sm-12">
                ...
                <form action="#">
                    ...
                    <b>Rating: </b> <img src="{{URL::to('frontend/img/product-details/rating.png')}}" alt="" />
                ...
                <div class="col-sm-4">
                    ...
                    <div class="single-products">
                        <div class="productinfo text-center">
                            <img src="{{URL::to('upload/product/'.$relate->product_image)}}" alt="" />
